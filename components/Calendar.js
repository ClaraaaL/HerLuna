    ...
    return (
        <div className='flex flex-col gap-2'>
            <div className='grid grid-cols-5 gap-4'>
                <button onClick={() => { console.log("Left button clicked");
                    handleIncrementMonth(-1)
                }} className='mr-auto text-indigo-400 text-lg sm:text-xl duration-200 hover:opacity-60'><FaChevronLeft size={16} color="black" /></button>
                ...
                <button onClick={() => {
                    handleIncrementMonth(+1)
                }} className='ml-auto text-indigo-400 text-lg sm:text-xl duration-200 hover:opacity-60'><FaChevronRight size={16} color="black" /></button>
            </div>
